...
export default function CartSidebarFinal() {
    ...
    return (
        <div className={`fixed inset-0 z-[3000] transition-all duration-500 ${isCartOpen ? 'pointer-events-auto visible' : 'pointer-events-none invisible delay-500'}`}>
            ...
            <div
                className={`absolute right-0 top-0 h-full w-[460px] bg-white shadow-[-10px_0_30px_rgba(0,0,0,0.05)] flex flex-col transition-transform duration-[800ms] ease-[cubic-bezier(0.25,1,0.5,1)] ${isCartOpen ? 'translate-x-0' : 'translate-x-full'}`}
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-[28px] py-2 content-start">
                    {items.length === 0 ? (
