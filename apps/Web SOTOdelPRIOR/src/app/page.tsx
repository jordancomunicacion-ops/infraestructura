      ...
      <div className="horizontal-scroller">
        ...
        <section className="h-section split-layout" id="restaurante">
          <div className="split-text">
            ...
            {/* CoverManager/Soto Booking Engine */}
            <div className="booking-widget-container" style={{ display: 'flex', justifyContent: 'flex-start' }}>
              <button className="soto-widget-trigger btn-product" style={{ width: 'fit-content', padding: '1rem 2rem' }}>
                RESERVAR MESA
              </button>
            </div>
          </div>
        ...
        <section className="h-section split-layout" id="eventos">
          <div className="split-text">
            ...
            <button className="btn-product" id="trigger-event-modal" style={{ width: 'fit-content', padding: '1rem 2rem' }}>ORGANIZAR EVENTO</button>
          </div>
          <div className="split-visual">
        ...
        <section className="h-section philosophy-section" id="origen">
          <h2 className="big-lead">NO BUSCAMOS LA PERFECCIÓN. <br />BUSCAMOS EL ORIGEN.</h2>
        ...
        <section className="h-section end-section" id="contacto">
          ...
          <div className="end-links">
            ...
            <button id="trigger-contact-modal" className="social-icon-btn">
              <img src="/web/assets/icon_mail.svg" alt="Contacto" className="social-icon" />
            </button>
            <button className="social-icon-btn">
              <img src="/web/assets/icon_phone.svg" alt="Teléfono" className="social-icon" />
            </button>
          </div>
